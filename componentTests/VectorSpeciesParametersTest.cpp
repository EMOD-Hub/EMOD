...
SUITE( VectorSpeciesParametersTest )
{
    ...
    TEST_FIXTURE( VspFixture, TestMigration )
    {
        ...
        unique_ptr<IMigrationInfoVector> p_mi_species_1( collection[ 0 ]->p_migration_factory->CreateMigrationInfoVector( idreference, &nc_1, nodeid_suid_map, collection[0] ) );
        ...
        unique_ptr<IMigrationInfoVector> p_mi_species_2( collection[ 1 ]->p_migration_factory->CreateMigrationInfoVector( idreference, &nc_1, nodeid_suid_map, collection[1] ) );

...
#define PS_MAX_LIST (10000)
                                                   ...
                                                   tGetIndexFunc func)
    {
        ...
        std::vector<float>::const_iterator it = std::lower_bound( PS_vector_score.begin(),
                                                                  PS_vector_score.end(),
                                                                  ran_score );
        if( it != PS_vector_score.end() )
        {
            int index = it - PS_vector_score.begin();
            return PS_vector_partner[ index ];
        }
        else
        {
            return nullptr;

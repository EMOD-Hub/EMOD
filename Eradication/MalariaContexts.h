...
namespace Kernel
{
    ...
    struct IMalariaSusceptibility : public ISupports
    {
        ...
        virtual const std::vector<MalariaAntibody>& GetMSPAntibodies( float currentTime, float dt ) = 0;
        virtual const std::vector<MalariaAntibody>& GetPfEMP1MajorAntibodies( float currentTime, float dt ) = 0;
    };

...
void SimulationConfig::VectorInitConfig( const Configuration* inputJson )
{
    ...
    initConfigTypeMap( "Enable_Temperature_Dependent_Microsporidia_Infectivity", &(vector_params->temperature_dependent_microsporidia_infectivity), Enable_Temperature_Dependent_Microsporidia_Infectivity_DESC_TEXT, false );
    initConfigTypeMap( "Microsporidia_Arrhenius1", &(vector_params->microsporidia_arrhenius1), Microsporidia_Arrhenius1_DESC_TEXT, 0.0f, 10000000000.0f, 61599956.864f, "Enable_Temperature_Dependent_Microsporidia_Infectivity" );
    initConfigTypeMap( "Microsporidia_Arrhenius2", &(vector_params->microsporidia_arrhenius2), Microsporidia_Arrhenius2_DESC_TEXT, 0.0f, 10000000000.0f, 5754.033f, "Enable_Temperature_Dependent_Microsporidia_Infectivity" );

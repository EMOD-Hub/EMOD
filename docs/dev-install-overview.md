...
source code on computers running Windows 11, Windows Server 12, and Windows HPC Server 12 (64-bit) or build the Eradication binary for Linux on computers running
Ubuntu 22.04.

After building, you should run a single simulation to verify basic functionality. We recommend the
27_Vector_Sandbox scenario in the [Regression](https://github.com/EMOD-Hub/EMOD/tree/main/Regression) directory, which is a simple five-year vector
...
The EMOD executable (Eradication.exe) is tested using Windows 11, Windows Server 12, and Windows HPC Server 12 (64-bit). Windows HPC Server is used for testing remote

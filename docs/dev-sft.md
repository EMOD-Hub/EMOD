...
All of the files can be found in the Regression directory of the [EMOD](https://github.com/EMOD-Hub/EMOD/tree/main/Regression) GitHub repository.
...
1.  Generate a single config.json file from a base file and the parameter_overrides.json that contains.
    For instructions, see emod-generic:software-configuration-overlay for generic.
    emodpy-hiv:emod/software-configuration-overlay for HIV, or
    emodpy-malaria:emod/software-configuration-overlay for malaria.
